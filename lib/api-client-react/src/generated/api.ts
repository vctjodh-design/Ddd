 ...
 */
export const getFixtures = async (params?: GetFixturesParams, options?: RequestInit): Promise<FixturesResponse> => {

  return customFetch<FixturesResponse>(getGetFixturesUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getGetFixturesQueryOptions = <TData = Awaited<ReturnType<typeof getFixtures>>, TError = ErrorType<ErrorResponse>>(params?: GetFixturesParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getFixtures>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetFixturesQueryError = ErrorType<ErrorResponse>
...
export function useGetFixtures<TData = Awaited<ReturnType<typeof getFixtures>>, TError = ErrorType<ErrorResponse>>(
